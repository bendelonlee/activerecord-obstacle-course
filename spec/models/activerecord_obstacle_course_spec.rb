...
describe 'ActiveRecord Obstacle Course' do
  ...
  it "13. groups an order's items by name" do
    ...
    # ------------------ Using ActiveRecord ----------------------
    grouped_items = Order.find(3).items #didn't order them by name
    # ------------------------------------------------------------
  ...
  it '16. returns the names of users who ordered one specific item' do
    ...
    # ------------------ Using ActiveRecord ----------------------
    users = User.distinct.joins(orders: :order_items).where("order_items.item_id=#{item_8.id}").order(:name).pluck(:name)
    # ------------------------------------------------------------
  ...
  it '23. returns all orders which include item_4' do
    ...
    # ------------------ Improved Solution ----------------------
    orders = Order.joins(:order_items).where(order_items: {item_id: item_4})
    # -----------------------------------------------------------
  ...
  it '24. returns all orders for user 2 which include item_4' do
    ...
    # ------------------ Improved Solution ----------------------
    orders = Order.joins(:order_items).where(user: user_2).where(order_items: {item: item_4})
